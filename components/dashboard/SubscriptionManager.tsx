...
if (loading) {
  return <p className="text-center py-10 text-gray-500">Loading subscription...</p>;
}
      ...
      {business ? (
        <>
          <p className="text-gray-600 mb-2">
            You are currently subscribed to <strong>{business.plan || 'N/A'}</strong>.
          </p>
          <p className="text-gray-600 mb-4">
            Subscription status: <strong>{business.subscriptionStatus || 'N/A'}</strong>
          </p>
        ...
        <p className="text-center text-gray-500">No subscription found for this account.</p>
      )}
    </div>
  </div>
);
